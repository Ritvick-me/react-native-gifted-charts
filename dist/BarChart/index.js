...
export var BarChart = function (props) {
    ...
    var verticalInterval = props.verticalLineInterval || 1;
    ...
    return (_jsx(BarAndLineChartsWrapper, __assign({}, barAndLineChartsWrapperProps, { scrollRef: scrollRef, renderChartContent: renderChartContent, remainingScrollViewProps: remainingScrollViewProps, nestedScrollEnabled: props.nestedScrollEnabled, verticalInterval: verticalInterval, scrollViewContainerStyles: props.scrollViewContainerStyles, showBackgroundRange: props.showBackgroundRange, normalRangeColor: props.normalRangeColor, normalRangeColorOpacity: props.normalRangeColorOpacity, normaRangeBackgroundHeight: props.normaRangeBackgroundHeight, normaRangeBackgroundWidth: props.normaRangeBackgroundWidth, normaRangeBottomPosition: props.normaRangeBottomPosition })));
};
